...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function registerEvents(chatHub) {
            ...
            $('#btnSendMsg').click(function () {
                ...
                if (msg.length > 0) {
                    ...
                    //chatHub.server.deleteMessageFromAll('#btnSendMsg');
                    $("#txtMessage").val('');
                }
            });
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.onConnected = function (id, userName, allUsers, messages, times) {
                ...
                for (i = 0; i < messages.length; i++) {
                    AddMessage(messages[i].UserName, messages[i].Message, messages[i].Time, messages[i].UserImage, messages[i].id);
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg, id ) {

                AddMessage(userName, message, time, userimg, id);
            }

            chatHub.client.messageDelete = function (id) {
                console.log('detele signalr')
                DeleteMessage(id);
        ...
        function AddMessage(userName, message, time, userimg, id) {
            ...
            var divChat = '<div class="direct-chat-msg ' + Side + '">' +
                ...
                ' <div class="direct-chat-text" id="' + 'div' + id + '">' + message + '</div> <button id="' + id + '" type="button" class="close" aria-label="Close"><span aria-hidden="true">X</span></button></div>';
            ...
            window.hubReady.done(function () {
                ...
                $(`#${id}`).on('click',function () {
                    ...
                    chatHub.server.deleteMessageFromAll(id);
                });
                                    ...
                                    <tr>
                                        ...
                                        <div class="col-md-12">
                                            <td class="text-primary col-md-4" style="font-weight: bold;">
                                                <img id="ImgDisp" class="user-image" style="height: 100px;" />
                                            </td>
                                            <td class="text-primary col-md-4" style="font-weight: bold;">
